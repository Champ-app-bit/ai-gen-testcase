...
argument-hint: <คำอธิบายฟีเจอร์ ภาษาไทย> [--project <ชื่อ config>] [--unattended]
...
- ไม่มีคำอธิบายฟีเจอร์ → **หยุดทันทีพร้อมบอกว่าขาดอะไร** (อย่าเดาว่าจะทำ module ไหน)
- ถ้าไม่พบ spec/เทสเดิม → ทำงานต่อตามปกติ (ถือว่าทุกกติกาเป็น ❌) แล้วระบุไว้ในผล — ไม่ใช่เหตุให้หยุด
